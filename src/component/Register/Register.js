...
const Register = () => {
    ...
    <section class="max-w-4xl p-6 mx-auto bg-slate-300 mt-20 rounded-md shadow-md dark:bg-gray-800">
    ...
    <form>
        ...
        <div class="flex justify-start mt-6">
            <button class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">REGISTER</button>
        </div>
    </form>
</section>
    );
